...
set output 'append_left_and_get.png'
...
deque_f(x) = deque_c*x*x + deque_a*x + deque_b  # quadratic fit for deque

# Fit the data
fit meque_f(x) 'append_left_and_get.meque.data' using 2:3 via meque_a,meque_b
fit deque_f(x) 'append_left_and_get.deque.data' using 2:3 via deque_c,deque_a,deque_b


# Add fit parameters to plot
set label 1 sprintf("meque: y = %.2e x + %.2e", meque_a, meque_b) at graph 0.05,0.95
set label 2 sprintf("deque: y = %.2e x^2 + %.2e x + %.2e", deque_c, deque_a, deque_b) at graph 0.05,0.90


# Plot the data and fits
plot meque_f(x) title 'meque fit' with lines ls 1 lw 3 dt 1, \
     'append_left_and_get.meque.data' using 2:3 title 'meque' with points ls 1 pt 7 ps 0.1, \
     deque_f(x) title 'deque fit' with lines ls 2 lw 3 dt 2, \
     'append_left_and_get.deque.data' using 2:3 title 'deque' with points ls 2 pt 7 ps 0.1
...
print "deque: a = ", deque_a, ", b = ", deque_b, ", c = ", deque_c
